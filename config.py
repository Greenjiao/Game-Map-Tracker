...
ROUTE_DRAWING_PANEL_COLLAPSED = settings.get("ROUTE_DRAWING_PANEL_COLLAPSED") or {}
ROUTE_DRAWING_SHOW_DETAIL = settings.get("ROUTE_DRAWING_SHOW_DETAIL", True)
...
REGION_LABEL_MAJOR_VISIBLE = settings.get("REGION_LABEL_MAJOR_VISIBLE")
REGION_LABEL_MINOR_VISIBLE = settings.get("REGION_LABEL_MINOR_VISIBLE")
REGION_LABEL_MAJOR_FONT_SIZE = settings.get("REGION_LABEL_MAJOR_FONT_SIZE")
REGION_LABEL_MINOR_FONT_SIZE = settings.get("REGION_LABEL_MINOR_FONT_SIZE")
REGION_LABEL_SCALE_SWITCH_RATIO = settings.get("REGION_LABEL_SCALE_SWITCH_RATIO")
ANNOTATION_LABEL_VISIBLE = settings.get("ANNOTATION_LABEL_VISIBLE")
POINT_LAYER_VISIBLE = settings.get("POINT_LAYER_VISIBLE")
QUARK_DOWNLOAD_URL = ""
ROUTE_RESOURCE_URL = ""
